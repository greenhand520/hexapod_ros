...
namespace ubtech_servo_hardware {
    ...
    public:
        ...
        /// @param default_val Initial output value (0 = low)
        /// @return true on success
        bool open(const std::string& chip_path, unsigned int line_num,
                  const std::string& consumer = "ubtech_servo", int default_val = 0);
